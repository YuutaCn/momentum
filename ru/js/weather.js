...
async function getWeather() {
  requestWeather.open('GET', `https://api.openweathermap.org/data/2.5/weather?q=${localStorage.getItem('cityWeather')}&lang=ru&APPID=b133c0863e4c74d75d9872210e91ebdc`, true);
  ...
  requestWeather.onload = function () {
    ...
    descriptionHTML.innerHTML = `${description.replace(/\w\S*/g, (w) => (w.replace(/^\w/, (c) => c.toUpperCase())))}`;
    windHTML.innerHTML = `${wind.toFixed(0)} м/с`;
